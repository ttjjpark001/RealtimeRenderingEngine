...
| RAM | 32 GB |
| GPU | MSI RTX 5060 Ti 16G Shadow 2X OC |
| VRAM | 16 GB GDDR7 |
...
RTX 5060 Ti 16GB(Blackwell)는 Phase 32~48 전 기능을 제약 없이 구현·검증할 수 있다.
상세 분석은 아래 [RTX 5060 Ti 16GB 분석 섹션](#asus-dual-geforce-rtx-5060-ti-16gb-분석-2026-03-15-추가)을 참조한다.

| Phase 범위 | 가능 여부 | 비고 |
|-----------|----------|------|
| Phase 32-36 (전처리, Hi-Z, CubeMap, 애니) | ✅ 완전 동작 | |
| Phase 37-44 (Deferred + 포스트) | ✅ 완전 동작 | 1080p/1440p 모두 여유 |
| Phase 45 (DDGI) | ✅ 완전 동작 | |
| Phase 46 (DXR) | ✅ 하드웨어 완전 검증 가능 | DXR Tier 1.1 네이티브 |
| Phase 47 (Mesh Shader) | ✅ 하드웨어 완전 검증 가능 | SM 6.9 |
| Phase 48 (DLSS 4 + FSR 3 + NRD) | ✅ DLSS 4 네이티브 지원 | |

---

## MSI RTX 5060 Ti 16G Shadow 2X OC 분석 (2026-03-15 추가)

> MSI Gaming RTX 5060 Ti 16G Shadow 2X OC (16GB GDDR7, 128-bit, PCIe 5.0, DLSS 4, HDMI 2.1b, DisplayPort 2.1a)
